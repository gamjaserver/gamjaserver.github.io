...
let shadingMode = '4';       // 'FLAT' or 'SMOOTH'
...
function setupKeyboardEvents() {
    document.addEventListener('keydown', (event) => {
        if (event.key == 'a') {
            ...
            shader.use();
            shader.setInt('u_toonlevel',1);
            shadingMode = '1';
            updateText(textOverlay3, "toon levels: " + shadingMode);
            render();
        }
        else if (event.key == '2') {
            shader.use();
            shader.setInt('u_toonlevel',2);
            shadingMode = '2';
            updateText(textOverlay3, "toon levels: " + shadingMode);
            render();
        }
...
async function main() {
    try {
        ...
        textOverlay3 = setupText(canvas, "toon levels: " + shadingMode, 3);
